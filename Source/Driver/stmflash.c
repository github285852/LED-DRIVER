...
{
	STMFLASH_Write(CONFIG_ADDRESS,(u16 *)&Sys.Config,sizeof(Sys.Config));
}

void LoadConfig(void)
{
	STMFLASH_Read(CONFIG_ADDRESS,(u16 *)&Sys.Config,sizeof(Sys.Config));
	if(Sys.Config.check==0xffffffff)//为初始化的
	{
